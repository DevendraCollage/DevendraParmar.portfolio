        ...
        <div className="container grid grid-four-column">
          ...
          <div className='footer-icons'>
            ...
            <div className="footer-social--icons">
              ...
              <div>
                <a href="https://devendraparmar2023.blogspot.com/" target='_blank'>
                  <FaBlogger className='icons'/> 
                </a>
              </div>
              <div>
                <a href="https://www.linkedin.com/in/devendra-parmar-458877245/" target='_blank'>
                  <FaLinkedin className='icons'/> 
                </a>
              </div>
              <div>
                <a href="https://www.hackerrank.com/profile/devendraparmar22" target='_blank'>
          ...
          {/* 3 rd column for contact */}
          <div className="footer-contact">
                <h3>Contact</h3>
                <h3>+91 8849020930</h3>
          </div>

          {/* 3 rd column for email */}
          <div className="footer-contact">
                <h3>Email</h3>
                <h3>devendraparmar2023@gmil.com</h3>
          </div>
        </div>
